...
const About = () => {
  return (
    <section id="about" className="flex flex-col lg:flex-row items-center gap-8">
      {/* Image Section */}
      ...
      <div className="w-full lg:w-[587px] text-center lg:text-left  text-white">
        <h1 className="text-[60px] lg:text-[80px] font-MonaSansWide leading-[115%] tracking-tight">
          More than a Voice, A <br className="hidden lg:flex"/>Vessel
        </h1>

        <p className="mt-4 sm:mt-6 text-[14px] lg:text-[22px] font-MonaSans leading-relaxed">
        ...
        <Link to="/about">
        <button className="text-white border border-white rounded-full px-[36px] py-3 mb-6 sm:py-[20px] mt-6 sm:mt-8 text-[14px] lg:text-[22px]  hover:bg-white hover:text-black transition-all duration-300 font-MonaSans cursor-pointer">
          Learn More
        </button>
        </Link>
      </div>
