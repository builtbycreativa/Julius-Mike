    ...
    <section className="relative w-full min-h-screen">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 sm:px-6 lg:px-10 text-center text-white">
        <div className="max-w-4xl space-y-6">
          ...
          <Link to="/booking">
            <button className="text-white border border-white rounded-full px-6 sm:px-8 lg:px-12 py-3 sm:py-4 mt-4 sm:mt-6 hover:bg-white hover:text-black transition-all duration-300">
              Book an appointment
            </button>
          </Link>
        </div>
