  ...
  return (
    <div className="relative z-10 min-h-screen flex items-center justify-center px-4 sm:px-6 md:px-10 lg:px-20 text-white">
      <div className="w-full max-w-[600px] md:max-w-[700px] lg:max-w-[900px] xl:max-w-[1200px] space-y-6 text-center md:text-left">
        <h1 className="text-[60px] sm:text-5xl md:text-7xl xl:text-[80px] pt-40 font-bold leading-tight md:leading-[90px]">
          Sound From
          <br />
          The Spirit
        </h1>

        <p className="text-base sm:text-lg md:text-xl xl:text-2xl font-medium leading-relaxed max-w-[463px]">
